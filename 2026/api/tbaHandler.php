...
class tbaHandler
{
  ...
  public function getStrategicMatches($eventCode, $scheduleFilter)
  {
    error_log("starting getStrategicMatches for eventCode: $eventCode, filter: $scheduleFilter");
    $out = array();
    ...
    return BuildStratSchedule::getMatches($ml, $scheduleFilter);
  }
