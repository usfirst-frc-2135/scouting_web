          ...
          <div id="collapseEndgame" class="card-body collapse">
            <table id="endgameClimbTable" class="table table-striped table-bordered table-hover table-sm border-dark text-center ">
              ...
              <tbody class="table-group-divider">
                <tr>
                  <td id="teamEndgameTitle1" class="card-title">Team 1</td>
                  <td> </td>
                  <td> </td>
                  <td> </td>
                  <td> </td>
                ...
                <tr>
                  <td id="teamEndgameTitle2" class="card-title">Team 2</td>
                  <td> </td>
                  <td> </td>
                  <td> </td>
                  <td> </td>
        ...
        <div class="row mb-3">
          ...
          <div id="freeze-table" class="freeze-table overflow-auto">
            <table id="averagesTable"
              ...
              <tbody class="table-group-divider">
                <tr>
                  <td id="teamTitle1" class="card-title">Team 1</td>
                  <td> </td>
                  <td> </td>
                  <td> </td>
                  <td> </td>
                ...
                <tr>
                  <td id="teamTitle2" class="card-title">Team 2</td>
                  <td> </td>
                  <td> </td>
                  <td> </td>
                  <td> </td>
