 ...
 *   https://datatables.net/download/#bs5/jq-3.7.0/dt-2.3.1/fc-5.0.4/fh-4.0.2/rr-1.5.0
 *
 * Included libraries:
 *   jQuery 3.7.0, DataTables 2.3.1, FixedColumns 5.0.4, FixedHeader 4.0.2, RowReorder 1.5.0
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5/jq-3.7.0/dt-2.3.1/fc-5.0.4/fh-4.0.2/rr-1.5.0",
