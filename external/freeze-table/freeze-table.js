...
(function ($, window) {
  ...
  FreezeTable.prototype.init = function() {
    ...
    this.frozenColVerticalOffset = (typeof options.frozenColVerticalOffset !== 'undefined') ? options.frozenColVerticalOffset : 0;
  ...
  FreezeTable.prototype.buildColumnTable = function() {
    ...
    var localizeWrap = function () {
      ...
      that.$columnTableWrap.offset({top: that.$tableWrapper.offset().top+that.frozenColVerticalOffset});
    }
